...
Note: This is a fork of "Craft" from https://github.com/fogleman/Craft.
...
#### Linux (Ubuntu)
    ...
    sudo apt-get install cmake libglew-dev xorg-dev libcurl4-openssl-dev libglfw3-dev glslang-tools
